...
class PairDataloader(Dataset):
    ...
    """
    def __init__(self, rtstruct_path, img_size=(128, 128), date=None):


        self.dataloader = RTStructSliceDataset(rtstruct_path, img_size)
        self.date =  date
    ...
    def _load_ct_image(self, ui):
        ...
        self.dataloader.load_ct_image(ui)
    ...
    def __getitem__(self, idx):
        ...
        item1 = self.dataloader.__getitem__(idx*2)
        item2 = self.dataloader.__getitem__(idx*2+1)
